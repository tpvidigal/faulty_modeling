fsimplex = fopen('/media/vidigal/Dados/Git/tcctpv/pid/tb/tb_Fault_Analysis/time_to_fail_Simplex.txt','r');
ftmredun = fopen('/media/vidigal/Dados/Git/tcctpv/pid/tb/tb_Fault_Analysis/time_to_fail_TMR.txt','r');
ftmrsimp = fopen('/media/vidigal/Dados/Git/tcctpv/pid/tb/tb_Fault_Analysis/time_to_fail_TMRSimplex.txt','r');
